...
public class GameUI {
	...
	public GameUI(Display di, Context context){
		...
		buttonLeft = new Rect((int)(2*dp),(int)(d.getHeight()-60*dp),(int)(d.getWidth()/2-1*dp),(int)(d.getHeight()-2*dp));
		buttonRight = new Rect((int)(d.getWidth()/2+1*dp),(int)(d.getHeight()-60*dp),(int)(d.getWidth()-2*dp),(int)(d.getHeight()-2*dp));
		buttonNitro = new Rect((int)(d.getWidth()-54*dp),(int)(d.getHeight()-225*dp),(int)(d.getWidth()-4*dp),(int)(d.getHeight()-75*dp));
		buttonBackToMenu = new Rect((int)(10*dp), (int)(10*dp), (int)(160*dp), (int)(60*dp));
	}
