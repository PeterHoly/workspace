...
public class SurfacePanel implements PaintListener {
	...
	private Game myGame = new Game(
			new com.example.bclib.Display(0, 0, 320, 410));
	private String[] args;
	...
	public SurfacePanel(String[] args) {
		...
		org.eclipse.swt.graphics.Color color = display
	...
	private void OnCreate() {
		...
		this.menu = new DesktopMenu(display, shell, this.myThread.getClient(),
				myGame.getDisplay(), myGame, this);
	}
	...
	public void paintControl(PaintEvent e) {
		...
		r.drawImg(e, shell, nitroPressed,
